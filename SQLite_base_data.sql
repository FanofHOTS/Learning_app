INSERT INTO "user" (username,email,password,icon,"role",is_password_reset,created_at,updated_at) VALUES
...
INSERT INTO "profile" (user_id,name,email,location,organization,description,specialization) VALUES
...
INSERT INTO "category" ("name",description,created_at,updated_at) VALUES
	 ('Công dân số','Đây là phân loại cho các khóa học liên quan đến công dân số','2026-05-18 17:03:10.143571','2026-05-18 17:03:10.14364');