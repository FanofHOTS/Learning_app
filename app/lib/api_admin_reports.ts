...
const mockCourses: FastAPICourse[] = [
  ...
  { id: 4, title: "Toán rời rạc", category_id: 3, instructor_id: 4, introduction: "Toán rời rạc ứng dụng.", description: "Khóa học toán rời rạc.", level: "Trung bình", total_module: 5, total_student: 115, image: "/logo.png", is_active: true, is_public: true },
  ...
  { id: 7, title: "Cơ sở dữ liệu", category_id: 4, instructor_id: 6, introduction: "Kiến thức cơ sở dữ liệu.", description: "SQL và dữ liệu quan hệ.", level: "Trung bình", total_module: 7, total_student: 102, image: "/logo.png", is_active: true, is_public: true },
  ...
  { id: 10, title: "Thiết kế dashboard cho giảng viên", category_id: 4, instructor_id: 7, introduction: "Thiết kế dashboard.", description: "Dashboard và báo cáo.", level: "Trung bình", total_module: 6, total_student: 94, image: "/logo.png", is_active: true, is_public: false },
];
