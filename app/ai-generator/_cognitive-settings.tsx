...
export default function CognitiveSettings({
  ...
  const total = value.difficultyRemember + value.difficultyUnderstand + value.difficultyApply;
      ...
      <div>
        ...
        <div className="mt-3 space-y-4">
          ...
          <div className="flex items-center justify-between rounded-xl bg-slate-100 px-3 py-2 text-xs">
            ...
            <span className={`font-semibold ${total === 100 ? "text-emerald-700" : "text-amber-700"}`}>
              {total}%
            </span>
          </div>
        </div>
